...
<body>
    ...
    <header>
        ...
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            <a class="navbar-brand" href="#">Austin's Movie List</a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link disabled" href="dashboard2.php">Home <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <div id="formFooter">
                ...
                <a class="underLineHover" href="login2.html">Already Have an Account?</a>
            </div>
